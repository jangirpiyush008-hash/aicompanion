...
export default function BestAIGirlfriendApps() {
  return (
    <BestOfPage
      ...
      entries={[
        { rank: 1, reviewSlug: 'secret-desires', bestFor: 'Best AI girlfriend app overall', note: 'Best-in-class creation, image consistency, and memory. Fair pricing. Our current top pick.' },
