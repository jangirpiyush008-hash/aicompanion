...
import { sdaiProfileHref } from '../utils/affiliate'
...
const CHARACTERS: Character[] = [
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('anna-lewis-G94Htw'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('eleanor-turner-wAxZag'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('jenny-tanaka-b7OU-g'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('jules-jordan-3sXElQ'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('lina-white-K0m9pw'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('natalie-craven-CUyGZQ'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('sova-briarley-Jl0OkA'),
    seo: {
...

  {
    ...
    sdaiProfileUrl: sdaiProfileHref('yumiko-fujii-H9QtcQ'),
    seo: {
